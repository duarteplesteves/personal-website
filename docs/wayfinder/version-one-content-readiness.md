# Version-one content readiness checklist
...
Display in this order. Both entries are active Independent work, may be named publicly, and need no public link for launch.
...
Display the following four launch stories. Home carries a complete summary for each; no Selected Work detail page is required in version one.

| Item | Settled facts and public status | Disclosure and permission boundary | Safe source pointer | Required public destination | Readiness |
| --- | --- | --- | --- | --- | --- |
| The personal home | Ongoing Independent work to create Duarte's bilingual personal home. The story may discuss the restrained content-led design, static Octane delivery, repository-authored bilingual content, Effect-first tooling, accessibility, performance, and the reasoning behind those choices. | Report only decisions and behavior that are true at publication. Distinguish intended architecture from what was actually shipped. No external publication permission is required. | This repository and the linked wayfinding decisions. | None beyond the Home on which the summary appears. | Ready for implementation as a Home summary. A Selected Work detail page is deliberately deferred until the implementation supplies enough evidence and lessons. |
| Identity-provider operations platform | Past Pixelmatters client work on an internal platform for high-stakes identity-provider operations, including complex operational workflows. | Pixelmatters may be named; the client, delivery partners, confidential workflows, and non-public operational details may not. Scope every claim to Duarte's contribution and team context. | Duarte's qualified recollection; no confidential source is copied or linked. | None. | Ready for implementation within the anonymized boundary. |
...
Display one company stint per entry in reverse chronological order. Employer names, role titles, and dates are public; client identities remain subject to the Selected Work boundaries above.

| Company | Role and dates | Safe responsibility boundary | Safe source pointer | Required public destination | Readiness |
| --- | --- | --- | --- | --- | --- |
| Pixelmatters | Frontend Engineer · September 2025–present | Frontend engineering across client product work and the public Pixelmatters website. | Duarte's confirmed employment history and [LinkedIn](https://www.linkedin.com/in/duarteplesteves). | None. | Ready for implementation; confirm the role remains ongoing before publication. |
...
Use one compact, ungrouped **Setup and tools** list rather than separate Setup and Tools groups:

1. MacBook Pro M5 Pro
2. Zed
3. Ghostty
4. Herdr
5. Pi
...
The required public contact destinations are settled:

- **Email:** [`duarteplesteves@gmail.com`](mailto:duarteplesteves@gmail.com)
- **GitHub:** [`https://github.com/duarteplesteves`](https://github.com/duarteplesteves)
- **LinkedIn:** [`https://www.linkedin.com/in/duarteplesteves`](https://www.linkedin.com/in/duarteplesteves)
...
- **Currently reading:** *O Som e a Fúria* — William Faulkner
- **Favorites:**
...
- **Next reads:** none; the empty group is omitted
...
- [Shape the personal home's story and release boundaries](https://github.com/duarteplesteves/personal-website/issues/2)
- [Establish the publishable Work inventory](https://github.com/duarteplesteves/personal-website/issues/3)
- [Decide the Selected Work presentation](https://github.com/duarteplesteves/personal-website/issues/9)
- [Decide whether tools and ways of working belong](https://github.com/duarteplesteves/personal-website/issues/14)
- [Decide what the Home Library preview communicates](https://github.com/duarteplesteves/personal-website/issues/15)
- [Decide the Selected Work editorial structure](https://github.com/duarteplesteves/personal-website/issues/17)
- [Decide Effect's role in version-one repository tooling](https://github.com/duarteplesteves/personal-website/issues/19)
- [Decide the version-one content readiness boundary](https://github.com/duarteplesteves/personal-website/issues/22)
- [Design the version-one content architecture](https://github.com/duarteplesteves/personal-website/issues/25)
- [Prepare the initial Library catalog from Notion](https://github.com/duarteplesteves/personal-website/issues/26)
